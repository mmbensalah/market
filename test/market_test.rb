...
class MarketTest < Minitest::Test
  ...
  def test_vendors_starts_as_empty_array
    market = Market.new("South Pearl Street Farmers Market")
    assert_equal [], market.vendors
  end

  def test_market_can_return_added_vendors
    market = Market.new("South Pearl Street Farmers Market")
  ...
  def test_vendor_names_returns_names
    market = Market.new("South Pearl Street Farmers Market")
    vendor_1 = Vendor.new("Rocky Mountain Fresh")
    vendor_2 = Vendor.new("Ba-Nom-a-Nom")
    vendor_3 = Vendor.new("Palisade Peach Shack")
  ...
  def test_vendors_sell_returns_correct_vendors
    market = Market.new("South Pearl Street Farmers Market")
    vendor_1 = Vendor.new("Rocky Mountain Fresh")
  ...
  def test_returns_market_items_sorted
    market = Market.new("South Pearl Street Farmers Market")
    vendor_1 = Vendor.new("Rocky Mountain Fresh")
    vendor_1.stock("Peaches", 35)
    vendor_1.stock("Tomatoes", 7)
  ...
  def test_sell_returns_boolean
    ...
    assert market.sell("Peaches", 50)
    refute market.sell("Onions", 1)
    assert market.sell("Banana Nice Cream", 5)
  end

  def test_returns_new_quantities_for_same_vendor_after_sold
    market = Market.new("South Pearl Street Farmers Market")
    vendor_1 = Vendor.new("Rocky Mountain Fresh")
    vendor_1.stock("Peaches", 35)
    vendor_1.stock("Tomatoes", 7)
  ...
  def test_returns_0_for_vendor_after_more_than_quantity_sold
    market = Market.new("South Pearl Street Farmers Market")
    vendor_1 = Vendor.new("Rocky Mountain Fresh")
    vendor_1.stock("Peaches", 35)
    vendor_1.stock("Tomatoes", 7)
